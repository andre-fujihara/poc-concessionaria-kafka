...
//
//import br.com.zup.poc.dto.CarroDTO;
...
//    	
//    	CarroDTO carro = CarroDTO.builder()
//    			.nome("audi")
//    			.build();
//
...
//       	CarroDTO carro1 = CarroDTO.builder()
//       			.id(1)
//       			.nome("Audi")
//    			.build();
//       	CarroDTO carro2 = CarroDTO.builder()
//       			.id(2)
//       			.nome("Astra")
//    			.build();
//       	
//       	List<CarroDTO> listCarros = Arrays.asList(carro1, carro2);
